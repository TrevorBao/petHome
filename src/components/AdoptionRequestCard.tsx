...
const AdoptionRequestCard = ({ pet }: Props) => {
  const placeholderImageUrl = "https://via.placeholder.com/150";
  const { declineAdoption, acceptAdoption } = useToggleAdoption();
  ...
  return (
    ...
    >
      ...
      <Flex direction="row" justify="center" gap={16}>
        <ConfirmAdoption acceptAdoption={() => acceptAdoption(pet.id)} />
