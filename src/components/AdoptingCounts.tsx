...
import DataPatatoIcon from "../assets/dataPatato.svg";
...
const AdoptingCounts = ({ userId }: Props) => {
      ...
      <CardBody>
        <Flex alignItems="center" justifyContent="center" wrap="wrap">
          ...
          >
            <Tooltip
              hasArrow
              label="The number of pending adoption requests you have"
              bg="#e6e6e6"
              color="black"
            >
              <Icon
